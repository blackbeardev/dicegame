...
var scores, roundScores, activePlayer, gamePlaying, dice, dice1, diceIcon, diceIcon2;
...
function resetScores() {
  ...
  //Set the default display styling of the two dices to be none.
  diceIcon = document.querySelector(".dice");
  diceIcon.style.display = "none";

  diceIcon2 = document.querySelector(".dice2");
...
document.querySelector(".btn-roll").addEventListener("click", function() {
  if(gamePlaying) {
    ...
    //2. Display the random number for the first dice
    // diceIcon = document.querySelector(".dice");
    ...
    //Display the random number for the second dice
    // diceIcon2 = document.querySelector(".dice2");
    diceIcon2.style.display = "block";
    diceIcon2.src = "dice-" + dice2 + ".png";
